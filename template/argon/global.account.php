...
function account($conn){
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $user = $row['userID'] * 1024;
            $user = rand(1000,9999) ."". $user;
            $user = md5(md5(md5($user),true));
            $user = "x-".rand(1000,9999)."".$user;
            echo"
                <tr>
                    <td>{$row['tran_date']}</td>
                    <td>{$user}</td>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="template/argon/assets/img/theme/team-4-800x800.jpg" class="rounded-circle">
                                </a>
                            </div>
                        </div>
