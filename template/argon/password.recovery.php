                            ...
                            <form method="post" action="login.php" enctype="multipart/form-data" role="form">
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control" name="email-recovery" value="" placeholder="Email" type="email">
                                    </div>
                                </div>
                                <div class="text-center">
                                    <input type="submit" name="submit" value="Recovery" class="btn btn-primary mt-4">
                                </div>
                            </form>
                        </div>
                    </div>
