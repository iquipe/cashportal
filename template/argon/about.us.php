...
<header class="header-global">
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom">
        <div class="container">
            <a class="navbar-brand mr-lg-5" href="template/argon/index.html">
                ...
                <div class="navbar-collapse-header">
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="template/argon/index.html">
                ...
                <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="template/argon/examples/landing.html" class="dropdown-item">Landing</a>
                            <a href="template/argon/examples/profile.html" class="dropdown-item">Profile</a>
                            <a href="template/argon/examples/login.html" class="dropdown-item">Login</a>
                            <a href="template/argon/examples/register.html" class="dropdown-item">Register</a>
                        </div>
                    </li>
                </ul>
        ...
        <div class="container">
            <div class="row row-grid align-items-center">
                <div class="col-md-6 order-md-2">
                    <img src="template/argon/assets/img/theme/promo-1.png" class="img-fluid floating">
                </div>
            ...
            <div class="row row-grid align-items-center">
                <div class="col-md-6">
                    <div class="card bg-default shadow border-0">
                        <img src="template/argon/assets/img/theme/img-1-1200x1000.jpg" class="card-img-top">
            ...
            <div class="row row-grid align-items-center">
                <div class="col-md-6 order-lg-2 ml-lg-auto">
                    <div class="position-relative pl-md-5">
                        <img src="template/argon/assets/img/ill/ill-2.svg" class="img-center img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="px-4">
                        <img src="template/argon/assets/img/theme/team-1-800x800.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
                ...
                <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="px-4">
                        <img src="template/argon/assets/img/theme/team-2-800x800.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
                        <div class="pt-4 text-center">
                            <h5 class="title">
                ...
                <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="px-4">
                        <img src="template/argon/assets/img/theme/team-3-800x800.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
                        <div class="pt-4 text-center">
                            <h5 class="title">
                ...
                <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="px-4">
                        <img src="template/argon/assets/img/theme/team-4-800x800.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
                        <div class="pt-4 text-center">
                            <h5 class="title">
    ...
    <div class="container container-lg">
        <div class="row">
            <div class="col-md-6 mb-5 mb-md-0">
                <div class="card card-lift--hover shadow border-0">
                    <a href="template/argon/examples/landing.html" title="Landing Page">
                        <img src="template/argon/assets/img/theme/landing.jpg" class="card-img">
                    </a>
                </div>
            </div>
            <div class="col-md-6 mb-5 mb-lg-0">
                <div class="card card-lift--hover shadow border-0">
                    <a href="template/argon/examples/profile.html" title="Profile Page">
                        <img src="template/argon/assets/img/theme/profile.jpg" class="card-img">
                    </a>
                </div>
            </div>
        </div>
