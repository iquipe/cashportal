                            ...
                            <div class='row'>
                                <div class='col-md-12'>
                                    <div class='form-group'>
                                        ...
                                        <input type='text' name='date' class='form-control' placeholder='Home Address' value='{$date}'>  
                                    </div>
                                </div>
                                <div class='col-md-12'>
                                    <div class='form-group'>
                                        <label>Pay To Mobile Number</label>
                                        <input type='text' name='mobile' class='form-control' placeholder='Home Address' value='{$mobile}'>
                                    </div>
                                </div>
                            </div>
                            <div class='row'>
        ...
        <div class='card-body '>
            ...
            <div class='table-responsive'>
                <table class='table tablesorter ' id=''>
                    ...
                    <tbody>
                    <?php user_wallet_transaction($conn,$userID);?>
                    </tbody>
                </table>
            </div>
            </p>
